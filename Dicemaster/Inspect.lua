...
local function PrimeInspectData( name )
	...
	Me.inspectData[name] = {
		...
		charges = {
			...
			count     = 0;
			max       = 0;
			tooltip   = "Representa el recurso personalizado del personaje.";
			symbol    = "charge-orb";
			flash     = true;
		};
		health        = 10;
...
StaticPopupDialogs["DICEMASTER4_SETTARGETHEALTHMAX"] = {
  text = "Fijar valor de salud máxima:",
  button1 = "Aceptar",
  button2 = "Cancelar",
  OnShow = function (self, data)
...
StaticPopupDialogs["DICEMASTER4_SETTARGETMANAMAX"] = {
  text = "Fijar valor máximo de Mana:",
  button1 = "Aceptar",
  button2 = "Cancelar",
  OnShow = function (self, data)
		...
		if store.manaType then
			...
			if store.manaType == "None" then
				...
				if Me.IsLeader( true ) then
					DiceMaster4.SetupTooltip( DiceMasterInspectFrame.mana, nil, manaType, nil, nil, nil, nil, "Representa el" .. manaType .. " del personaje.|n|cFF707070<Click Izquierdo/Derecho para Añadir/Disminuir>|n<Shift+Click Izquierdo para fijar el Máximo>|n<Ctrl+Click Izquierdo para fijar Valor>|r" )
				else
					DiceMaster4.SetupTooltip( DiceMasterInspectFrame.mana, nil, manaType, nil, nil, nil, nil, "Representa el" .. manaType .. " del personaje." )
				end
			end
		end
		
		if Me.IsLeader( true ) then
			DiceMaster4.SetupTooltip( DiceMasterInspectFrame.health, nil, "Salud", nil, nil, nil, nil, 
              "Representa la salud del personaje.|n|cFF707070<Click Izquierdo/Derecho para Añadir/Disminuir>|n<Shift+Click Izquierdo para fijar el Máximo>|n<Ctrl+Click Izquierdo para Fijar Valor>|n<Alt+Click Izquierdo/Derecho para Añadir/Disminuir Armadura>" )
        else
			DiceMaster4.SetupTooltip( DiceMasterInspectFrame.health, nil, "Salud", nil, nil, nil, nil, "Representa la salud del personaje." )
		end
