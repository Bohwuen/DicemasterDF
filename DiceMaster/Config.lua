	...
	args = { 
		...
		enableD10 = {
			...
			set = function( info, val )
				...
				Me.UpdateDiceEditBox()  -- Llama a la función para actualizar el EditBox
...
Me.configOptionsProgressBar = {
	...
	args = { 
		...
		moraleGroup = {
			name     = "Opciones de Maestro de Juego";
			inline   = true;
			order    = 16;
			type     = "group";
			args = {
				header = {
					order = 0;
					name  = "Estas opciones sólo son efectivas cuando eres lider de grupo o banda.";
					type  = "description";
				};
				...
				moraleSymbol = {
					...
					desc  = "Apariencia de la barra de progreso.";
					type  = "select"; 
					style = "dropdown";
					values = {
				...
				moraleTooltip = {
					order = 50;
					name  = "Descripción de barra de progresp";
					desc  = "La decripción del marco de la barra de progreso.";
					type  = "input";
					multiline = 3;
					width = "full";
					set = function( info, val ) 
				...
				moraleCount = {
					...
					desc  = "Este es el valor por defecto de la barra de progreso.";
					type  = "range"; 
					min   = 0;
					max   = 100;
					step  = 1;
				...
				moraleStep = {
					order = 70;
					name  = "Aumentar/Disminurir Valor";
					desc  = "La cantidad de valor que es dismunido al hacer click en la barra de progreso .";
					type  = "range"; 
					min   = 1;
					max   = 100;
					step  = 1;
				...
				moraleScale = {
					...
					desc      = "Cambia el tamaño de la barra de progreso.";
					type      = "range";
					min       = 0.25;
					max       = 10;
					softMax   = 4;
...
Me.configOptionsManager = {
	...
	args = { 
		...
		header = {
			order = 0;
			name  = "Configura las opciones del administrador de mazmorra.";
			type  = "description";
		};
		
		hideTracker = {
			order = 10;
			name  = "Habilitar administrador de mazmorra";
			desc  = "Habilita el marco administrador de Maestro de Juego para hacer un seguimientto de las tiradas del grupo, ver notas de grupo y acceder a nodos de mapa.";
			type  = "toggle";
			width = "double";
			set = function( info, val )
		...
		trackerScale = {
			order     = 20;
			name      = "Escala de Administrador de Mazmorras";
			desc      = "Administra el tamaño del administrador de mazmorras.";
			type      = "range";
			min       = 0.25;
			max       = 10;
			softMax   = 4;
		...
		trackerAnchor = {
			order = 30;
			name  = "Anclaje de marco";
			desc  = "Elige el anclaje del marco a Izquierda o Derecha.";
			type  = "select"; 
			style = "radio";
			values = {
				["LEFT"] = "Izquierda",
		...
		trackerKeybind = {
			order     = 40;
			name	  = "Seleccionar Tecla";
			desc      = "Fijar Tecla para habilitar Administrador de Mazmorra";
			type      = "keybinding";
			set = function( info, val ) 
