...
local foodTypes = { "Pan", "Queso", "Pescado", "Fruta", "Hongos", "Carne" };
...
function Me.LearnPetEditorDiet_OnLoad(frame, level, menuList)
	...
	info.text = "|cFFffd100Tipos de comida"
	...
	for i = 1,#foodTypes do
		...
		info.tooltipText = "Permite que esta mascota consuma " .. foodTypes[i]:lower() .. " objetos.";
...
function Me.LearnPetEditor_Refresh()
	...
	for i = 1, 3 do
		...
		_G["DiceMasterLearnPetEditorInset"..i.."PetIsEgg"]:SetChecked( false );
		_G["DiceMasterLearnPetEditorInset"..i.."PetIsEgg"]:Enable();
	end
...
function Me.LearnPetEditor_Load( effectIndex )
	...
	-- Set each stage
	for i = 1, #effect.stages do
		_G["DiceMasterLearnPetEditorInset"..i]:DesaturateHierarchy(0);
		_G["DiceMasterLearnPetEditorInset"..i]["ModelScene"]:GetActorAtIndex(1):SetModelByCreatureDisplayID(31);
		_G["DiceMasterLearnPetEditorInset"..i]["ModelScene"]:GetActorAtIndex(1):SetScale(effect.stages[i].scale);
		_G["DiceMasterLearnPetEditorInset"..i]["ModelScene"]["decreaseScale"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i]["ModelScene"]["increaseScale"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i]["ModelScene"]["selectModel"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i.."PetEnable"]:SetChecked( true );
		_G["DiceMasterLearnPetEditorInset"..i.."PetEnable"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i.."PetName"]:SetText(effect.stages[i].name);
		_G["DiceMasterLearnPetEditorInset"..i.."PetName"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i.."PetIcon"]:SetTexture(effect.stages[i].icon);
		_G["DiceMasterLearnPetEditorInset"..i.."PetIcon"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i.."PetDietText"]:SetText("|cFFFFD100Diet:|r (None)");
		_G["DiceMasterLearnPetEditorInset"..i.."PetDietButton"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i.."PetRequireWash"]:SetChecked( effect.stages[i].requiresWash );
		_G["DiceMasterLearnPetEditorInset"..i.."PetRequireWash"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i.."PetRequireCleanUp"]:SetChecked( effect.stages[i].requiresCleanUp );
		_G["DiceMasterLearnPetEditorInset"..i.."PetRequireCleanUp"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i.."PetRequireRest"]:SetChecked( effect.stages[i].requiresRest );
		_G["DiceMasterLearnPetEditorInset"..i.."PetRequireRest"]:Enable();
		_G["DiceMasterLearnPetEditorInset"..i.."PetIsEgg"]:SetChecked( effect.stages[i].isEgg );
		_G["DiceMasterLearnPetEditorInset"..i.."PetIsEgg"]:Enable();
	end

	-- Set both timers
	if effect.stages[2] then
		DiceMasterLearnPetEditorTimerOne.Cooldown.Duration = effect.stages[2].timer;
		DiceMasterLearnPetEditorTimerOne.Cooldown:SetCooldownUNIX(time() - ( 864000 - ( effect.stages[2].timer * 86400 )), 864000);
		DiceMasterLearnPetEditorTimerOne.Cooldown:Pause();
		DiceMasterLearnPetEditorTimerOne.Text:SetText( effect.stages[2].timer .. " d");
		DiceMasterLearnPetEditorTimerOne:Show()
	else
		DiceMasterLearnPetEditorTimerOne:Hide()
	end
	if effect.stages[3] then
		DiceMasterLearnPetEditorTimerTwo.Cooldown.Duration = effect.stages[3].timer;
		DiceMasterLearnPetEditorTimerTwo.Cooldown:SetCooldownUNIX(time() - ( 864000 - ( effect.stages[3].timer * 86400 )), 864000);
		DiceMasterLearnPetEditorTimerTwo.Cooldown:Pause();
		DiceMasterLearnPetEditorTimerTwo.Text:SetText( effect.stages[3].timer .. " d");
		DiceMasterLearnPetEditorTimerTwo:Show()
	else
		DiceMasterLearnPetEditorTimerTwo:Hide()
	end
...
function Me.LearnPetEditor_Save()
	...
	for i = 1, 3 do
		petData.stages[i].name = _G["DiceMasterLearnPetEditorInset"..i.."PetName"]:GetText();
		petData.stages[i].icon = _G["DiceMasterLearnPetEditorInset"..i.."PetIcon"]:GetTexture();
		petData.stages[i].diet = {};
		for type = 1, #Me.learnPet[i].foodTypes do
			tinsert( petData.stages[i].diet, Me.learnPet[i].foodTypes[type] );
		end
		petData.stages[i].requiresWash = _G["DiceMasterLearnPetEditorInset"..i.."PetRequireWash"]:GetChecked();
		petData.stages[i].requiresCleanUp = _G["DiceMasterLearnPetEditorInset"..i.."PetRequireCleanUp"]:GetChecked();
		petData.stages[i].requiresRest = _G["DiceMasterLearnPetEditorInset"..i.."PetRequireRest"]:GetChecked();
		petData.stages[i].isEgg = _G["DiceMasterLearnPetEditorInset"..i.."PetIsEgg"]:GetChecked();
	end

	if petData.stages[2] then
		petData.stages[2].timer = DiceMasterLearnPetEditorTimerOne.Cooldown.Duration;
	end
	if petData.stages[3] then
		petData.stages[3].timer = DiceMasterLearnPetEditorTimerTwo.Cooldown.Duration;
	end
